...
var LightboxComponent = /** @class */ (function () {
    ...
    LightboxComponent.prototype.control = function ($event) {
        ...
        if ($event.target.classList.contains('lb-turnLeft')) {
            ...
            this._lightboxEvent.broadcastLightboxEvent({ id: lightbox_event_service_1.LIGHTBOX_EVENT.DELETE, data: this.album[this.currentImageIndex].imageName });
        }
    };
    ...
    LightboxComponent.prototype._prepareComponent = function () {
        ...
        setTimeout(function () {
            ...
            _this.ui.showDeleteButton = _this.options.showDelete;
        }, 0);
    };
